...
{
    //Using W3Shools code for checking purpose.
    $email = $password = "";
    ...
    //Query to get user input email and password from databsae.
    $sql = "SELECT * FROM registration WHERE email = '$email' and passcode = '$password'";
